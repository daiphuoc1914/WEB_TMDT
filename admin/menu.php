...
<div class="d-flex"> <div class="d-flex flex-column p-3 bg-dark text-white" style="width: 250px; height: 100vh; flex-shrink: 0;">
        <h3 class="text-center mb-4">Dashboard</h3>
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item mb-2">
                <a href="../category_management" class="nav-link text-white">
                    <i class="bi bi-folder"></i> Category
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="../product_management" class="nav-link text-white">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                        <span class="me-2 d-none d-lg-inline text-secondary small fw-bold">Admin</span>
